...
const CreateDonateAdvertisement = () => {
    ...
    const handleSubmit = (event) => {
        ...
        DonateAdvertisementAPI.createDonateAdvertisement(data)
            .then((response) => {
                makeToast({
                    type: "success",
                ...
                <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
                    <div className="mt-6 overflow-hidden bg-white rounded-xl">
                        <div className="px-6 py-12 sm:p-12">
                            <h3 className="text-3xl font-semibold text-center text-gray-900">Create Advertisement</h3>
                            <form onSubmit={handleSubmit} className="mt-14">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                    ...
                                    <div className=" mt-3">
                                        ...
                                        <div className="mt-2.5 relative">
                                            <input required type="tel" name="phone" id="phone" placeholder="Enter Contact Number" className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" 
...
export default CreateDonateAdvertisement;
