...
const EducationUpdate = () => {
  ...
  const handleUpdate = (event) => {
    ...
    EduAdvertiestmentAPI.updateEduAdvertiestment(id, data)
      .then((response) => {
        makeToast({
          type: "success",
          message: "Education Advertisement Updated",
        });
        navigate("/education-advertisements");
      })
      .catch((err) => {
    ...
    <div>
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
        <h1 className="text-center text-3xl font-extrabold text-gray-900 mb-5">
          Update Education Advertisement
        </h1>
