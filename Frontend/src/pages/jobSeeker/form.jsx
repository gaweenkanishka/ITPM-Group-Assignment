...
const form = () => {
    return (
        <div class="w-full , bg-cover " style={{height:'95rem', backgroundImage: ' url(https://miro.medium.com/v2/resize:fit:700/1*u9SKsBuLPoQAhHzXzBzokA.jpeg)',background:'cover', backgroundSize:'100%'}}>
            <div class="flex justify-center h-full w-full bg-gray-900 bg-opacity-50">
                <div class="mt-12">
                    <h1 class="text-white mt-16 ml-80 text-2xl font-semibold uppercase md:text-3xl">Let's Connect for Zero poverty </h1>
                    <p className='font-semibold text-white text-xl mt-4 justify-center' >We’re so happy you’ve made it here! We'll assist you in getting
                        back to work if you're eager and driven to do so.
                    </p>
                </div>

                <div class="absolute items-center  mt-52 mx-24 lg:w-1/2 ">
                    <div
                ...
                <div class="container px-6 absolute">
                            <div class="text-center text-gray-800">
                                <div class="block rounded-lg shadow-lg px-6 py-6 md:py-12 md:px-8" style={{marginTop: '85%',marginBottom:'10px', background:' hsla(0, 0%, 100%, 0.7)',backdropFilter:'blur(30px)'}}>
                                        <h1 class=" xl:text-3xl font-bold tracking-tight mb-12">The best offer on the market <br /><span class="text-blue-600">for your business</span></h1>
