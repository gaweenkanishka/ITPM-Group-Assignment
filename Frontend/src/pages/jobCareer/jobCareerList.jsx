          ...
          <table class="min-w-full">
            <thead>
              <tr>
                ...
                <th class="px-6 py-3 border-b-2 border-gray-300 tracking-wider "></th>
              </tr>
            </thead>
            <tbody class="bg-white">
              <tr>
                ...
                <button class="px-5 py-2 border-green-500 border text-green-600 rounded transition duration-300 
                  hover:bg-green-800 hover:text-white focus:outline-none ml-4 mr-32">View Details</button>
                </td>
              </tr>
