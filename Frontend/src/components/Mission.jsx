...
export function mission() {
  return (
    <section className="text-#000000 bg-white-1000 body-font">
      <div className="container px-200 py-10 mx-auto">
        <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            className="inline-block w-8 h-8 text-#000000 mb-8"
          ...
          <p className="text-base font-medium text-gray-900 dark:text-#000000 ">
            Our mission “MANUSATHKAMA” works in 170 countries and territories to
            eradicate poverty while protecting the planet. We help countries
