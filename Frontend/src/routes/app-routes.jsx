    ...
    <>
      <Router>
        <Routes>
          ...
          <Route
            exact
            path="/donate-Advertisements/:id"
            element={<ViewHealthAdvertisement />}
          />
          <Route
            exact
            path="/event-Advertisements/:id"
            element={<ViewEventAdvertisement />}
          />
          <Route
            exact
            path="/donate-Advertisements/create"
            element={<CreateDonateAdvertisement />}
          />
          <Route
            exact
            path="/event-Advertisements/create"
            element={<CreateEventAdvertisement />}
          />
          <Route
            exact
            path="/donate-Advertisements/edit/:id"
            element={<EditDonateAdvertisement />}
          />
          <Route
            exact
            path="/event-Advertisements/edit/:id"
            element={<EditEventAdvertisement />}
          />
          ...
          <Route exact path="/foodAdd" element={<FoodAdd />} />
          <Route exact path="/foodList" element={<FoodList />} />
          <Route exact path="/foodOne/:id" element={<FoodOne />} />
          <Route exact path="/foodUpdate/:id" element={<FoodUpdate />} />

          {/* -------------------------Jobs------------------- */}
          <Route exact path="/jobHome" element={<JobHome />} />
          <Route exact path="/jobApplication" element={<JobApplication />} />
          <Route exact path="/jobList/:data" element={<JobList />}></Route>
